...
--
-- Name: individual_lesson_application_lesson_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.individual_lesson_application_lesson_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.individual_lesson_application_lesson_id_seq OWNER TO postgres;

--
-- Name: individual_lesson_application_lesson_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.individual_lesson_application_lesson_id_seq OWNED BY public.individual_lesson_application.lesson_id;
...
--
-- Name: lesson_pricing_salary_scheme_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.lesson_pricing_salary_scheme_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.lesson_pricing_salary_scheme_id_seq OWNER TO postgres;

--
-- Name: lesson_pricing_salary_scheme_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.lesson_pricing_salary_scheme_id_seq OWNED BY public.lesson.pricing_salary_scheme_id;
...
CREATE TABLE public.lesson_slot (
    ...
    end_time timestamp without time zone NOT NULL,
    lesson_id integer NOT NULL,
    total_number_of_student smallint,
    instructor_id integer NOT NULL
);
...
--
-- Name: multiple_student_lesson; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.multiple_student_lesson (
    lesson_id integer NOT NULL,
...
ALTER TABLE public.multiple_student_lesson OWNER TO postgres;

--
-- Name: multiple_student_lesson_lesson_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.multiple_student_lesson_lesson_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.multiple_student_lesson_lesson_id_seq OWNER TO postgres;

--
-- Name: multiple_student_lesson_lesson_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.multiple_student_lesson_lesson_id_seq OWNED BY public.multiple_student_lesson.lesson_id;
...
--
-- Name: individual_lesson_application lesson_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.individual_lesson_application ALTER COLUMN lesson_id SET DEFAULT nextval('public.individual_lesson_application_lesson_id_seq'::regclass);
...
--
-- Name: lesson pricing_salary_scheme_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lesson ALTER COLUMN pricing_salary_scheme_id SET DEFAULT nextval('public.lesson_pricing_salary_scheme_id_seq'::regclass);
...
--
-- Name: multiple_student_lesson lesson_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.multiple_student_lesson ALTER COLUMN lesson_id SET DEFAULT nextval('public.multiple_student_lesson_lesson_id_seq'::regclass);
...
COPY public.ensemble (lesson_id, genre) FROM stdin;
\.
...
COPY public.group_lesson (lesson_id, instrument, level) FROM stdin;
\.
...
COPY public.individual_lesson (lesson_id, instrument, level) FROM stdin;
\.
...
COPY public.individual_lesson_application (appointment_id, accepted, student_id, lesson_id) FROM stdin;
\.
...
COPY public.instrument_rental (id, rental_start_date, rental_return_date, school_id, rental_instrument_id, student_id) FROM stdin;
\.
...
COPY public.lesson (id, lesson_code, lesson_type, school_id, pricing_salary_scheme_id) FROM stdin;
\.
...
COPY public.lesson_application (lesson_slot_id, student_id, accepted) FROM stdin;
\.
...
COPY public.lesson_slot (id, start_time, end_time, lesson_id, total_number_of_student, instructor_id) FROM stdin;
\.


--
-- Data for Name: multiple_student_lesson; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.multiple_student_lesson (lesson_id, max_number_of_students, min_number_of_students) FROM stdin;
\.
...
COPY public.rental_instrument (id, instrument_id, rented, rental_instrument_description_id) FROM stdin;
\.
...
COPY public.skill_level (id, instrument, level) FROM stdin;
\.
...
COPY public.student (id, monthly_fee, age, person_id, guardian_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.guardian_id_seq', 1, false);
...
--
-- Name: individual_lesson_application_lesson_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.individual_lesson_application_lesson_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.instrument_rental_id_seq', 1, false);
...
--
-- Name: lesson_pricing_salary_scheme_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.lesson_pricing_salary_scheme_id_seq', 1, false);
...
--
-- Name: multiple_student_lesson_lesson_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.multiple_student_lesson_lesson_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.rental_instrument_description_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.rental_instrument_id_seq', 1, false);
...
ALTER TABLE ONLY public.lesson_application
    ADD CONSTRAINT lesson_application_pkey PRIMARY KEY (lesson_slot_id, student_id);
...
--
-- Name: multiple_student_lesson multiple_student_lesson_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.multiple_student_lesson
    ADD CONSTRAINT multiple_student_lesson_pkey PRIMARY KEY (lesson_id);
...
--
-- Name: individual_lesson_application individual_lesson_application_lesson_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.individual_lesson_application
    ADD CONSTRAINT individual_lesson_application_lesson_id_fkey FOREIGN KEY (lesson_id) REFERENCES public.lesson(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.individual_lesson
    ADD CONSTRAINT individual_lesson_lesson_id_fkey FOREIGN KEY (lesson_id) REFERENCES public.lesson(id);
...
ALTER TABLE ONLY public.lesson_application
    ADD CONSTRAINT lesson_application_lesson_slot_id_fkey FOREIGN KEY (lesson_slot_id) REFERENCES public.lesson_slot(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.lesson_application
    ADD CONSTRAINT lesson_application_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.student(id) ON DELETE CASCADE;


--
-- Name: lesson lesson_pricing_salary_scheme_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lesson
    ADD CONSTRAINT lesson_pricing_salary_scheme_id_fkey FOREIGN KEY (pricing_salary_scheme_id) REFERENCES public.pricing_salary_scheme(id);
...
ALTER TABLE ONLY public.lesson_slot
    ADD CONSTRAINT lesson_slot_instructor_id_fkey FOREIGN KEY (instructor_id) REFERENCES public.instructor(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.lesson_slot
    ADD CONSTRAINT lesson_slot_lesson_id_fkey FOREIGN KEY (lesson_id) REFERENCES public.lesson(id) ON DELETE CASCADE;


--
-- Name: multiple_student_lesson multiple_student_lesson_lesson_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.multiple_student_lesson
    ADD CONSTRAINT multiple_student_lesson_lesson_id_fkey FOREIGN KEY (lesson_id) REFERENCES public.lesson(id);
...
ALTER TABLE ONLY public.student_skill_level
    ADD CONSTRAINT student_skill_level_skill_level_id_fkey FOREIGN KEY (skill_level_id) REFERENCES public.skill_level(id);
...
ALTER TABLE ONLY public.student_skill_level
    ADD CONSTRAINT student_skill_level_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.student(id);
